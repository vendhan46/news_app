...
SECRET_KEY = 'django-insecure-zpewa@--va+d&#4-m7fs09r6p=xc^9-7c&a3r038#posba&n&-'
...
#SESSION_COOKIE_AGE = 600  # seconds (i.e., 5 minutes)
...
EMAIL_HOST_PASSWORD = 'mcde mahg exmq uotc'